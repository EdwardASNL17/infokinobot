...
get_afisha_callback = CallbackData("get_afisha_callback")
timetable_favorite_callback = CallbackData("timetable_favorite_callback", "movie_id")
get_favorites_callback = CallbackData("get_favorites_callback")
...
add_from_favorite_movie_callback = CallbackData("add_from_favorite_movie_callback", "movie_id")
delete_from_favorite_movie_callback = CallbackData("delete_from_favorite_movie_callback", "movie_id")
